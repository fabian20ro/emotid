...
describe('acceptance contract', () => {
  ...
  it('registers exact platform scope without sharing platform execution', async () => {
    ...
    expect(IOS_SIMULATOR_ACCEPTANCE_ADAPTER.journeyIds).toEqual(ANDROID_ACCEPTANCE_ADAPTER.journeyIds)
    expect(IOS_SIMULATOR_ACCEPTANCE_ADAPTER.complete).toBe(true)
