    ...
    <div className="screen" data-testid="privacy-screen">
      ...
      <div className="settings-list mt-6">
        <div className="settings-row privacy-setting-row">
          <span className="privacy-setting-copy">{t.saving}</span>
          <Toggle checked={saveSessions} label={t.saving} onChange={onSaveSessionsChange} />
        </div>
        <div className="settings-row privacy-setting-row">
          <span className="privacy-setting-copy"><ExternalLink size={20} aria-hidden="true" /><span>{t.external}<small>{t.externalHint}</small></span></span>
          <Toggle checked={allowExternalAI} label={t.external} onChange={onExternalAIChange} />
        </div>
      </div>
