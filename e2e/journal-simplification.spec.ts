...
const scenarios = [
  ...
  },
  {
    ...
    theme: 'light',
    journal: 'Jurnal',
    unpack: 'Desfă un moment',
    situation: 'Ce s-a întâmplat?',
    optional: 'Opțional',
    save: 'Salvează reflecția',
    done: 'Gata',
    exercises: 'Exerciții de jurnal',
    openExercises: 'Deschide exercițiile de jurnal',
    recent: 'Reflecții recente',
    clear: 'Șterge exercițiile din jurnal',
    confirm: 'Ștergi exercițiile din jurnal?',
    cancel: 'Anulează',
    explore: 'Explorează',
    practice: /exersează vocabularul emoțional/i,
    notSure: 'Nu știu încă',
    uncertaintyFeedback: 'Poți continua fără să alegi dintre aceste cuvinte.',
    continue: 'Continuă',
