...
test.describe('Primary check-in routes', () => {
  ...
  test('quick feeling reaches Meaning + Need and saves to Journal', async ({ page }) => {
    ...
    await expect(page.getByText(/You chose: anxiety. You can keep or revise your choice/i)).toBeVisible()
    ...
    await expect(page.locator('.meaning-block')).not.toContainText(/you are experiencing|your system is responding/i)
